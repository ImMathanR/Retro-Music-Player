...
package me.immathan.musicplayer.utils;
...
import me.immathan.musicplayer.R;
...
public class CircularSeekBar extends View {
	...
	/**
	 * true if you want to render the progress bar in counterclockwise
	 */
	...
	protected void initAttributes(TypedArray attrArray) {
		...
		isCounterClockWise = attrArray.getBoolean(R.styleable.CircularSeekBar_counterclockwise, false);
		...
		mStartAngle = (((360f + (attrArray.getFloat((R.styleable.CircularSeekBar_start_angle), DEFAULT_START_ANGLE) % 360f)) -180)% 360f);
		mEndAngle = (((360f + (attrArray.getFloat((R.styleable.CircularSeekBar_end_angle), DEFAULT_END_ANGLE) % 360f)) -180)% 360f);
